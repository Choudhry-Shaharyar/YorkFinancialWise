...
const GlobeIcon = ({width=24, height=24}) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="white" class="bi bi-globe2" viewBox="0 0 16 16">
  ...
  return (
    <>
      ...
      <Navbar className='navbar-custom' expand='sm'>
        ...
        <Dropdown.Menu>
          <Dropdown.Item className='dropdown-item-custom' id='item'>
            <button className='dropdown-item' id='btn-lang' onClick={()=> i18n.changeLanguage('en')}>
              <span className='flag-icon flag-icon-us'></span>
              English
            </button>
          </Dropdown.Item>
          <Dropdown.Item id='item'>
          <button className='dropdown-item' id='btn-lang' onClick={()=> i18n.changeLanguage('fr')}>
              <span className='flag-icon flag-icon-fr'></span>
              French
            </button>
          </Dropdown.Item>
          <Dropdown.Item id='item'>
          <button className='dropdown-item' id='btn-lang' onClick={()=> i18n.changeLanguage('in')}>
          ...
          <Dropdown.Item id='item'>
          <button className='dropdown-item' id='btn-lang' onClick={()=> i18n.changeLanguage('in')}>
              <span className='flag-icon flag-icon-ir'></span>
               Farsi
            </button>
          </Dropdown.Item>
        </Dropdown.Menu>
